...
namespace YG
{
    public class YandexGame : MonoBehaviour
    {
        ...
        public void InitializationSDK()
        {
            ...
            SetInitializationSDK(
                @"{""playerAuth"""
                    ...
                    + @"""playerId"""
                    + ": "
                    + @"""tOpLpSh7i8QG8Voh/SuPbeS4NKTj1OxATCTKQF92H4c="", "
                    + @"""playerPhoto"""
                    + ": "
        ...
        {
            if (!nowFullAd && !nowVideoAd && timerShowAd >= infoYG.fullscreenAdInterval)
            {
                timerShowAd = 0;
#if !UNITY_EDITOR
                FullAdShow();
        ...
        public static void DeletePurchase(string id)
        {
            ...
            if (PurchaseByID(id) != null)
            {
                ...
                Debug.LogError(@$"No purchase with this id ""{id}"" was found!");
        }
