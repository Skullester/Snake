        ...
        public override void OnInspectorGUI()
        {
            ...
            if (scr.infoYG)
            {
                if (scr.infoYG.translateMethod == InfoYG.TranslateMethod.CSVFile)
                {
                    ...
                    scr.componentTextField = EditorGUILayout.ToggleLeft(
                        "Component Text/TextMesh Translate",
                        scr.componentTextField
                    );
                    ...
                    if (scr.componentTextField)
                    {
                        ...
                        else if (scr.textMeshComponent)
                        {
                            ...
                            if (
                                scr.textMeshComponent == null
                                || scr.textMeshComponent.text.Length == 0
                            )
                                availableStr = false;
                        }
                    }
                    ...
                    scr.textHeight = EditorGUILayout.Slider(
                        "Text Height",
                        scr.textHeight,
                        20f,
                        400f
                ...
                else
                {
                    ...
                    if (scr.infoYG.translateMethod == InfoYG.TranslateMethod.AutoLocalization)
                    {
                        ...
                        if (!scr.componentTextField)
                            scr.text = EditorGUILayout.TextArea(
                                scr.text,
                                GUILayout.Height(scr.textHeight)
                            );
                        else
                        {
                            if (scr.textUIComponent)
                        ...
                        {
                            if (
                                scr.componentTextField || (scr.text == null || scr.text.Length == 0)
                            )
                            {
            ...
            if (scr.textUIComponent || scr.textMeshComponent)
            {
                ...
                scr.uniqueFont = (Font)
                    EditorGUILayout.ObjectField("Unique Font", scr.uniqueFont, typeof(Font), false);

                if (GUILayout.Button("Replace the font with the standard one"))
                {
                    if (
                        scr.infoYG.fonts.defaultFont.Length >= scr.fontNumber + 1
                        && scr.infoYG.fonts.defaultFont[scr.fontNumber]
                    )
                    {
                        if (scr.textUIComponent)
                    ...
                    {
                        Debug.LogError(
                            "The standard font is not specified! Specify it in the InfoYG plugin settings.  (ru) �� ������ ����������� �����! ������� ��� � ���������� ������� InfoYG",
                            scr.gameObject
                        );
                    }
                }
        ...
        void UpdateLanguages(bool CSVFile)
        {
            ...
            for (int i = 0; i < langArr.Length; i++)
            {
                if (langArr[i])
                {
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label(
                        new GUIContent(scr.infoYG.LangName(i), CSVManager.FullNameLanguages()[i]),
                        GUILayout.Width(20),
                        GUILayout.Height(20)
                    );
